  ...
  return (
    <div className="flex items-center justify-center min-h-screen w-screen bg-bg">
      <div className="bg-surface border border-border rounded-[10px] p-10 text-center w-[360px]">
        ...
        <button
          onClick={handleLogin}
          className="flex items-center justify-center gap-3 w-full px-4 py-2.5 border border-border rounded-lg hover:bg-border-light transition-colors text-[13px] font-medium text-text-primary cursor-pointer"
        >
