...
export const allStatuses = ['Research', 'In Conversation', 'Negotiation', 'On Hold', 'Trial', 'Waiting onboarding', 'Onboarding', 'Won', 'Lost', 'Former Client']
// 'Email' is intentionally not selectable — emails live in the Emails section now
export const activityTypes = ['Call', 'Follow-up', 'Meeting', 'Demo', 'Pakkumine', 'Note', 'Support', 'Other']
...
export const activityIcons = { 'Call': Phone, 'Email': Mail, 'Follow-up': Repeat2, 'Meeting': Calendar, 'Demo': LayoutGrid, 'Pakkumine': Receipt, 'Note': MessageSquare, 'Support': Headphones, 'Other': MoreHorizontal, 'Kõne': Phone, 'Kohtumine': Calendar, 'Märge': MessageSquare, 'Muu': MoreHorizontal }
